...
class CurrencyBase(BaseModel):
    ...
    name: str = Field(..., max_length=50, description="Full currency name, e.g., 'United States Dollar'")
    rate: float = Field(..., description="Exchange rate relative to a base currency (e.g., EUR)")
...
class CurrencyUpdate(BaseModel):
    ...
    code: str | None = Field(None, max_length=3, description="Currency code, e.g., 'USD'")
    name: str | None = Field(None, max_length=50, description="Full currency name, e.g., 'United States Dollar'")
    rate: float | None = Field(None, description="Exchange rate relative to a base currency (e.g., EUR)")
